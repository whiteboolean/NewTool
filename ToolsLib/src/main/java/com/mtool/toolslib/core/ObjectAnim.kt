...
class ObjectAnim {
    companion object {
        ...
        fun setHeartPonpingAnim(view: View, isCollect: Boolean, setCollect: () -> Unit) {
            if (isCollect) {
                val frame0 = Keyframe.ofFloat(0f, 1f)
                val frame1 = Keyframe.ofFloat(0.1f, 0.9f)
                val frame2 = Keyframe.ofFloat(0.2f, 0.8f)
                val frame3 = Keyframe.ofFloat(0.3f, 0.7f)
                val frame4 = Keyframe.ofFloat(0.4f, 0.6f)
                val frame5 = Keyframe.ofFloat(0.5f, 0.5f)
                val frame6 = Keyframe.ofFloat(0.6f, 0.4f)
                val frame7 = Keyframe.ofFloat(0.7f, 0.3f)
                val frame8 = Keyframe.ofFloat(0.8f, 0.2f)
                val frame9 = Keyframe.ofFloat(0.9f, 0.1f)
                val frame10 = Keyframe.ofFloat(1f, 0f)

                val frameHolder1 = PropertyValuesHolder.ofKeyframe("alpha", frame0, frame1, frame2, frame3, frame4, frame5, frame6, frame7, frame8, frame9, frame10)

                view.animWithMultiProperty(frameHolder1)
                        .animDurationSec(1f)
                        .animListener(
                                animStart = {
                                },
                ...
                val frame0 = Keyframe.ofFloat(0f, 1f)
                val frame1 = Keyframe.ofFloat(0.1f, 1.2f)
                val frame2 = Keyframe.ofFloat(0.2f, 0.7f)
                val frame3 = Keyframe.ofFloat(0.3f, 1.2f)
                val frame4 = Keyframe.ofFloat(0.4f, 0.7f)
                val frame5 = Keyframe.ofFloat(0.5f, 1.2f)
                val frame6 = Keyframe.ofFloat(0.6f, 0.7f)
                val frame7 = Keyframe.ofFloat(0.7f, 1.2f)
                val frame8 = Keyframe.ofFloat(0.8f, 1f)

                val frameHolder1 = PropertyValuesHolder.ofKeyframe("scaleX", frame0, frame1, frame2, frame3, frame4, frame5, frame6, frame7, frame8)
                val frameHolder2 = PropertyValuesHolder.ofKeyframe("scaleY", frame0, frame1, frame2, frame3, frame4, frame5, frame6, frame7, frame8)

                view.animWithMultiProperty(frameHolder1, frameHolder2)
                        .animDurationSec(1f)
                        .animListener(
                                animStart = {
                                },
 ...
 * 动画执行 时间配置
 */
fun ObjectAnimator.animDurationSec(durationSec: Float = 2f) = also {
    this.duration = (durationSec * 1000).toLong()
    return this
}
 ...
 * 动画执行 时间配置
 */
fun ObjectAnimator.animStartDelay(delay: Long = 2) = also {
