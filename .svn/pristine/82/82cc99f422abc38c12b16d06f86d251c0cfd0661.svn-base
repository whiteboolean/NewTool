package com.mtool.toolslib.base.view.custom.cornerBanner;
...
public class LabelLinearLayoutView extends LinearLayout {

    LabelViewHelper utils;

    public LabelLinearLayoutView(Context context) {
        this(context, null);
    }

    public LabelLinearLayoutView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LabelLinearLayoutView(Context context, AttributeSet attrs, int defStyleAttr) {
