...
class RecyclerViewWithSwipeView {
    ...
    private fun initRecyclerView() {
        ...
        refreshLayout?.setColorSchemeColors(ContextCompat.getColor(ActivityControlManager.topContext(), R.color.colorAccent))
    }
    ...
    private fun createFooterView(): RefreshFooterLayout {
        val footer = RefreshFooterLayout(ActivityControlManager.topContext())
